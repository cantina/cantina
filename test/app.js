...
/****************************************************************************/
describe('utils plugin', function () {
  beforeEach(function (done) {
    app.init(done);
  });

  it('can use app.utils.defaults()', function () {
    var obj = {
      a: 'A',
      b: 'B'
    };
    ...
    app.utils.defaults(obj, defaults);
  ...
  it('can use app.utils.defaults(true) (Deep)', function () {
    var obj = {
      a: 'A',
      b: {
        c: 'C',
    ...
    app.utils.defaults(true, obj, defaults);
    assert.deepEqual(obj, {
      a: 'A',
      b: {
        c: 'C',
  ...
  it('can call app.utils.defaults() with more than one defaults', function () {
    var obj = {
      a: 'A'
    };
    var one = {
    ...
    app.utils.defaults.apply(app.utils, [true, obj, one, two, three]);
    assert.deepEqual(obj, {
      a: 'A',
      b: 'B',
      c: {
